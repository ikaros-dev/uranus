...
public class UranusGLSurfaceViewRenderer implements GLSurfaceView.Renderer {
    ...
    public UranusGLSurfaceViewRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        String vertexSource = UranusShaderUtil.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = UranusShaderUtil.readRawTxt(context, R.raw.fragment_shader);
        program_yuv = UranusShaderUtil.createProgram(vertexSource, fragmentSource);
